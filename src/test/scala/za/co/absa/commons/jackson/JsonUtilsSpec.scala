...
package za.co.absa.commons.jackson

import org.scalatest.flatspec.AnyFlatSpec
import org.scalatest.matchers.should.Matchers

class JsonUtilsSpec extends AnyFlatSpec with Matchers {
  it should "test JSON pretty formatting from a JSON string" in {
  ...
  it should "test JSON pretty formatting from a Spark JSON string" in {
